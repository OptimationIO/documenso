...
if [ -f "$CERT_PATH" ] && [ -r "$CERT_PATH" ]; then
    ...
    printf "💡 Tip: Aplyio will still start, but document signing will be unavailable\n"
    printf "🔧 Check: http://localhost:3000/api/certificate-status for detailed status\n"
fi

printf "\n📚 Useful Links:\n"
printf "📖 Documentation: https://docs.aplyio.com\n"
printf "🐳 Self-hosting guide: https://docs.aplyio.com/developers/self-hosting\n"
printf "🔐 Certificate setup: https://docs.aplyio.com/developers/self-hosting/signing-certificate\n"
