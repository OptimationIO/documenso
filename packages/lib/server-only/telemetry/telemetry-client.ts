...
export class TelemetryClient {
  ...
  private async initialize(): Promise<void> {
    ...
    console.log(
      '[Telemetry] Telemetry is enabled. Aplyio collects anonymous usage data to help improve the product.',
    );
    console.log(
    ...
    console.log(
      '[Telemetry] Learn more: https://aplyio.com/docs/developers/self-hosting/telemetry',
    );
