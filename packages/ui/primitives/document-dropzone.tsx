        ...
        <CardContent className="text-muted-foreground/40 flex flex-col items-center justify-center p-6">
          {disabled ? (
            ...
            <div className="flex">
              ...
              >
                <div className="bg-muted-foreground/20 group-hover:bg-aplyio h-2 w-full rounded-[2px]" />
                <div className="bg-muted-foreground/20 group-hover:bg-aplyio h-2 w-5/6 rounded-[2px]" />
                <div className="bg-muted-foreground/20 group-hover:bg-aplyio h-2 w-full rounded-[2px]" />
              </motion.div>
              <motion.div
              ...
              >
                <Plus
                  strokeWidth="2px"
                  className="text-muted-foreground/20 group-hover:text-aplyio h-12 w-12"
                />
              </motion.div>
              <motion.div
