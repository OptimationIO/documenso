...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'Aplyio - Share' },
    { description: 'I just signed a document in style with Aplyio!' },
    {
      property: 'og:title',
      content: 'Aplyio - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with Aplyio!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for Aplyio.
  throw redirect('https://aplyio.com');
};
