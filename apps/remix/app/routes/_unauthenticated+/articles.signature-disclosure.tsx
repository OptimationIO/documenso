  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using Aplyio to perform your electronic document signing. The purpose
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by Aplyio, you affirm
