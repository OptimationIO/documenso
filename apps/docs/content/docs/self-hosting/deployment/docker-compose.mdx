...
description: Deploy Aplyio with Docker Compose, including PostgreSQL. This production-ready setup is suitable for most self-hosted deployments.
---
...
The Aplyio container waits for the database health check to pass before starting.
...
# Public URL where Aplyio is accessible
...
For production, place Aplyio behind a reverse proxy for SSL termination:
