---
title: Kubernetes
description: Deploy Aplyio on Kubernetes for production environments requiring high availability, auto-scaling, and enterprise-grade infrastructure.
---
...
A typical Aplyio Kubernetes deployment consists of:
...
Create a dedicated namespace for Aplyio:
...
Update your Aplyio secret to use the in-cluster database:
...
Aplyio stores documents in the database by default. For high-volume deployments, configure S3-compatible storage.
...
Scale Aplyio based on CPU and memory utilization:
