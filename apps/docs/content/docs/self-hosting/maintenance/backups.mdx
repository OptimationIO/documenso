---
title: Backups
description: Backup strategies for Aplyio data.
---
...
Aplyio stores data in three locations:
...
Create a script to back up all Aplyio components:
...
echo "Starting Aplyio backup: $TIMESTAMP"
...
```ini
[Unit]
Description=Daily Aplyio Backup
