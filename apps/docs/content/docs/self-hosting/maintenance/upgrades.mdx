---
title: Upgrades
description: Upgrade your self-hosted Aplyio installation to get the latest features, security patches, and bug fixes.
---
...
Aplyio follows [Semantic Versioning](https://semver.org/):
...
Check your running Aplyio version:
...
Aplyio runs database migrations automatically when the container starts. No manual intervention is required.
