...
description: Diagnose and resolve common issues with your self-hosted Aplyio instance, organized by component.
---
...
Aplyio exposes a health endpoint to verify the application is running:
...
<Steps>
  ...
  <Step>
    Change Aplyio's port mapping: `-p 3001:3000`
  </Step>
</Steps>
...
```
  ...
  <Step>
    Update the certificate file and restart Aplyio
  </Step>
</Steps>
...
- **[Discord](https://aplyio.com/discord)**: Join the Aplyio community Discord
...
For security vulnerabilities, do not open a public issue. Contact security@aplyio.com directly.
