...
description: Integrate Aplyio into your applications using the REST API, webhooks, and embedding options.
---
...
<Cards>
  ...
  <Card
    title="Self-Hosting"
    description="Deploy your own Aplyio instance."
