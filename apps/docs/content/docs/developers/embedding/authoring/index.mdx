...
In addition to embedding signing, Aplyio supports embedded authoring. It allows your users to create and edit documents, templates, and envelopes without leaving your application.

<Callout type="warn">
  Embedded authoring is included with [Enterprise](https://aplyio.com/enterprise-cta) plans. It is
  also available as a paid add-on for the [Platform Plan](https://aplyio.com/platform-cta-pricing).
...
This endpoint requires your Aplyio API key. The token has a default expiration of 1 hour.

See the [API documentation](https://openapi.aplyio.com/reference#tag/embedding) for full details.
