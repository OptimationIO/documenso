...
Aplyio offers two types of embedding:
...
The [Platform Plan](https://aplyio.com/platform-cta-pricing) adds enhanced customization:

- Custom CSS and styling variables
- Dark mode controls
- Removal of Aplyio branding
...
<Steps>
<Step>
Navigate to your team's templates in Aplyio
...
For example, `https://app.aplyio.com/d/-WoSwWVT-fYOERS2MI37k` has the token `-WoSwWVT-fYOERS2MI37k`.
...
| `host`                | `string`   | Aplyio instance URL. Defaults to `https://app.aplyio.com`. |
