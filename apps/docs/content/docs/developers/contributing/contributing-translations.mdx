...
description: Learn how to contribute translations to Aplyio and become part of our community.
---
...
msgid "Want to send slick signing links like this one? <0>Check out Aplyio.</0>"
msgstr "Möchten Sie auffällige Signatur-Links wie diesen senden? <0>Überprüfen Sie Aplyio.</0>"
```
...
<Callout type="info">
  If you have any questions, hop into our [Discord](https://aplyio.com/discord) and ask us directly!
</Callout>

Thank you for helping make Aplyio more accessible to users around the world!
