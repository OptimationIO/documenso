---
title: Manual Setup
description: Manually set up Aplyio on your machine for local development.
---
...
Follow these steps to set up Aplyio on your local machine:
...
Fork the [Aplyio repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
...
Access the Aplyio application by visiting `http://localhost:3000` in your web browser.
