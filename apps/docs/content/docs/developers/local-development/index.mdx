...
description: Learn how to set up Aplyio for local development.
---

## Overview

There are multiple ways of setting up Aplyio for local development. At the moment of writing this documentation, there are 3 ways of running Aplyio locally:
...
<div className="mt-16 flex items-center justify-center gap-4">
  <a href="https://aplyio.com/discord">
    <img
      src="https://img.shields.io/badge/Discord-aplyio.com/discord-%235865F2"
      alt="Join Aplyio on Discord"
    />
  </a>
...
- [Contributing](/docs/developers/contributing) - Learn how to contribute to Aplyio
