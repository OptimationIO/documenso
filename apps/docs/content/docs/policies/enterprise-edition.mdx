...
description: Commercial license that removes AGPL-3.0 source code disclosure requirements, allowing organisations to integrate Aplyio into proprietary products.
---
...
- **Build proprietary products**: Integrate Aplyio into commercial software without releasing source code
...
- **Need to keep modifications private**: Any changes to Aplyio source code that you don't want to disclose

<Callout type="info">
  If you run Aplyio without modifications, or your modifications are open source under AGPL-3.0,
...
| SaaS product using Aplyio API only        | Community Edition  |
| SaaS product with modified Aplyio code    | Enterprise Edition |
...
<Accordions type="multiple">
  <Accordion title="License Rights">
    ...
    - **Proprietary integration**: Embed Aplyio in closed-source products without licensing conflicts.
    - **Sublicensing options**: Distribute Aplyio as part of your product to your customers (terms vary by agreement).
  ...
  <Accordion title="License Setup">
    1. Acquire a license by contacting [sales](https://aplyio.com/enterprise)
    2. Access your license key at [license.aplyio.com](https://license.aplyio.com)
    ...
    4. Restart your Aplyio instance
...
<Accordions type="multiple">
  <Accordion title="Grant of License">
    The Enterprise license is a commercial agreement between your organisation and Aplyio. Key terms include:

    - **Scope**: License to use, modify, and distribute Aplyio as specified in your agreement
    - **Exclusions**: The license does not grant rights to Aplyio trademarks beyond what's specified
  ...
  <Accordion title="What the License Does Not Cover">
    ...
    - Aplyio Cloud service (separate subscription)
...
| Factor              | Description                         |
| ------------------- | ----------------------------------- |
| **Deployment type** | Self-hosted or Aplyio Cloud      |
...
Contact [sales](https://aplyio.com/enterprise) for current pricing. Enterprise agreements typically include:
...
<Steps>
  ...
  <Step>
    ...
    - Email: [sales@aplyio.com](https://aplyio.com/enterprise)
  ...
  <Step>
    ...
    Options for evaluating Aplyio before purchase:
  ...
  <Step>
    ...
    3. Deploy using [self-hosting guides](/docs/self-hosting) or access Aplyio Cloud
...
<Accordions type="multiple">
  ...
  <Accordion title="Does the Enterprise license include Aplyio Cloud?">
  ...
  <Accordion title="Is there a trial period?">
    Contact [sales](https://aplyio.com/enterprise) to discuss evaluation options for your
    organisation.
  </Accordion>
</Accordions>
