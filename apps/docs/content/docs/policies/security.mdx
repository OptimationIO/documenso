---
title: Security
description: Security practices for Aplyio Cloud and self-hosted deployments, along with our vulnerability disclosure process.
---
...
<Accordions type="multiple">
  <Accordion title="Encryption in Transit">
    All data transmitted to and from Aplyio is encrypted using TLS 1.2 or higher. This includes:
  ...
  <Accordion title="Application-Level Encryption">
    Aplyio encrypts sensitive data at the application level:
...
Aplyio operates a responsible disclosure process for security vulnerabilities.
...
When self-hosting Aplyio, you are responsible for the security of your deployment. The following recommendations apply:
...
- **Security vulnerabilities**: security@aplyio.com
- **General questions**: support@aplyio.com
