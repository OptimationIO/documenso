...
<Callout type="info">
  Aplyio seals all signed documents cryptographically, regardless of signature level, to prevent
...
## What Aplyio Provides

Aplyio supports Simple Electronic Signatures (SES) with features that enhance evidentiary value:
