---
title: GDPR
description: Understand how Aplyio handles GDPR compliance for data processing and storage.
---
...
When using Aplyio for document signing, two distinct data processing roles apply:

| Role                | Description                                                                           |
| ------------------- | ------------------------------------------------------------------------------------- |
| **Data Controller** | You (the organisation using Aplyio) determine the purposes and means of processing |
| **Data Processor**  | Aplyio processes personal data on your behalf according to your instructions       |
...
Aplyio processes personal data necessary to provide document signing services:
...
Where your data is stored depends on how you use Aplyio:

<Tabs items={['Aplyio Cloud', 'Self-Hosted']}>
<Tab value="Aplyio Cloud">
...
Contact Aplyio for specific information about sub-processors and data centre locations.

</Tab>
<Tab value="Self-Hosted">

When you self-host Aplyio:

- You control all data storage locations
- No data is transmitted to Aplyio's infrastructure
...
- Export user and document data from your Aplyio account
- Delete user accounts and associated documents
- Contact Aplyio support for assistance with cloud-hosted data

## Data Deletion

Aplyio supports data deletion to help fulfill erasure requests:
...
Self-hosting Aplyio can simplify GDPR compliance:
...
- Contact [support@aplyio.com](mailto:support@aplyio.com) to request a DPA
- The DPA covers Aplyio's obligations as a data processor

</Tab>
<Tab value="Self-Hosted">

No DPA with Aplyio is required since no personal data is processed by Aplyio.
...
This documentation is provided for informational purposes only and does not constitute legal advice. GDPR compliance depends on your specific circumstances, including how you use Aplyio, what data you process, and your organisation's obligations.
...
- [Self-Hosting Guide](/docs/self-hosting) - Deploy Aplyio on your own infrastructure
