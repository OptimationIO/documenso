...
description: Sign up for Aplyio and configure your profile.
---
...
See the [pricing page](https://aplyio.com/pricing) for feature details and limits.
...
Navigate to [aplyio.com/free](https://aplyio.com/free) to create a free account. To start with a paid plan, visit the [pricing page](https://aplyio.com/pricing) and select your plan.
...
Check your inbox for a verification email and click the confirmation link. The email is sent from `noreply@aplyio.com`.
...
For custom branding, team collaboration, API access, and other advanced features, you'll need a paid plan. Explore the [pricing page](https://aplyio.com/pricing) and choose the plan that fits your needs.
...
<Steps>
  <Step>
    ...
    ![Aplyio account security page showing security options](/get-started-images/documenso-account-security-page.webp)
