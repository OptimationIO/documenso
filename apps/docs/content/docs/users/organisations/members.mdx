...
Organisation ownership cannot be transferred through the regular organisation settings. Only a Aplyio instance administrator can transfer ownership through the admin panel.

If you are using Aplyio Cloud, contact support to request an ownership transfer. If you are self-hosting, an instance administrator can follow the steps below.
...
<Steps>
  ...
  <Step>
    Sign in or create a Aplyio account.
  </Step>
  <Step>
