---
title: Overview
description: Organisations are the top-level entity in Aplyio, containing teams, members, and shared settings.
---
...
Organisations are the top-level entity in Aplyio's hierarchy. Each organisation can contain multiple teams, and each team can have multiple members.
...
![Create organisation in Aplyio dashboard](/organisations/organisations-create.webp)
