---
title: Email Domains
description: Learn how to create and manage email domains in Aplyio.
---
...
Email Domains allow you to send emails to recipients from your own domain instead of the default Aplyio email address.
...
- Access to your Aplyio organisation as an admin or manager
...
After adding your domain, Aplyio will provide you with the following required DNS records that need to be configured on your domain:
...
Once you've added the DNS records, return to the Aplyio email domains settings page and click the "Verify" button.
