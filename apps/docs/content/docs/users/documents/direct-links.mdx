...
- **Create one automatically**: Aplyio creates a new "Direct Link Recipient" for you
...
```
https://app.aplyio.com/d/<unique-token>
```
...
If the recipient has a Aplyio account with the email they entered, the document also appears in their Documents dashboard.
...
You can showcase templates with direct links on your public Aplyio profile:
...
![Aplyio profile with direct links](/direct-links/documenso-profile.webp)
...
```html
<a href="https://app.aplyio.com/d/your-token">Sign our agreement</a>
```
