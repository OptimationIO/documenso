...
<Callout type="warn">
  Aplyio does not support password-protected or encrypted PDF files. Remove encryption before
  uploading.
</Callout>
...
<Steps>
  <Step>
    ...
    Open your [Documents dashboard](https://app.aplyio.com/documents).
...
1. **Processing**: Aplyio validates the PDF and extracts page information
