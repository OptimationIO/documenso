# Contributing to Aplyio

If you plan to contribute to Aplyio, please take a moment to feel awesome ✨ People like you are what open source is about ♥. Any contributions, no matter how big or small, are highly appreciated.
...
- Accept the [Contributor License Agreement](https://aplyio.com/cla) to ensure we can accept your contributions.
...
The development branch is <code>main</code>. All pull requests should be made against this branch. If you need help getting started, [join us on Discord](https://aplyio.com/discord).
